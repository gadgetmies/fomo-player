...
def get_next_analysis_tracks(id_token, model='discogs_multi_embeddings-effnet-bs64-1', batch_size=5):
    res = requests.get(
        f"https://fomoplayer.com/api/admin/analyse?model={model}&batch_size={batch_size}",
...
if __name__ == '__main__':
    ...
    tracks_to_process = get_next_analysis_tracks(id_token)

...
waveform_storage_url = os.getenv("FOMO_PLAYER_WAVEFORM_STORAGE_URL")
waveform_storage_client = Minio(waveform_storage_url,
                                access_key=os.getenv("FOMO_PLAYER_WAVEFORM_BUCKET_ACCESS_KEY"),
                                secret_key=os.getenv("FOMO_PLAYER_WAVEFORM_BUCKET_SECRET_KEY"),
                                )

waveform_storage_bucket = os.getenv("FOMO_PLAYER_WAVEFORM_STORAGE_BUCKET_NAME")

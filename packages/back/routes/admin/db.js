...
module.exports.queryNextTracksToAnalyse = async ({ model, batch_size }) => {
...
GROUP BY track_id, track_isrc, cart_is_purchased
ORDER BY cart_is_purchased NULLS LAST, MAX(store__track_published) DESC
LIMIT ${batch_size || 20}
    `,
  )
}
